...
concat(Direccion,' ', Ciudad, ' ', CodigoPostal, ' ', Pais ) AS Dirección
FROM  proveedores;
...
WHERE Dirección LIKE '%Americanas%' OR Dirección LIKE 'Brazil';
...
ProductoNombre AS 'Nombre_del_Producto', 
round(PrecioUnitario) AS 'Precio_Unitario', 
UnidadesStock AS 'Unidades_en_Stock', 
UnidadesPedidas AS 'Unidades_Pedidas',
CASE 
...
SELECT PRIORIDAD, count(*) AS Cantidad_Productos, avg(Precio_Unitario) AS 'Precio_Promedio' FROM  vista_productos
GROUP BY PRIORIDAD
